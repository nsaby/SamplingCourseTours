See https://www.youtube.com/watch?v=SGPwBNoDQaA&ab_channel=ManikaLamba before
# Specifying an R environment with a runtime.txt file


RStudio: [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/nsaby/SamplingCourse/RunSamplingCourse/master?urlpath=rstudio)
